$(document).ready(function () {
    ...
    rangeSlider.noUiSlider.on("update", function (values, handle) {
        ...
        document.getElementById("min-value").value = moneyFormat.from(
            values[0].replace(/[^0-9]/g, "")
        );
        document.getElementById("max-value").value = moneyFormat.from(
            values[1].replace(/[^0-9]/g, "")
        );
    });

    var tuitionRangeSlider = document.getElementById("tuition-slider-range");
    var tuitionMoneyFormat = wNumb({
        prefix: "",
        thousand: ",",
        decimals: 0,
    });
    noUiSlider.create(tuitionRangeSlider, {
        start: [0, 100000],
        step: 1000,
        range: {
            min: [0],
        ...
        format: tuitionMoneyFormat,
        connect: true,
    });

    tuitionRangeSlider.noUiSlider.on("update", function (values, handle) {
        document.getElementById("tuition-slider-range-value1").innerHTML =
            values[0];
        document.getElementById("tuition-slider-range-value2").innerHTML =
            values[1];
        document.getElementById("tuition_min_value").value =
            tuitionMoneyFormat.from(values[0].replace(/[^0-9]/g, ""));
        console.log(tuitionMoneyFormat.from(values[0].replace(/[^0-9]/g, "")));
        document.getElementById("tuition_max_value").value =
            tuitionMoneyFormat.from(values[1].replace(/[^0-9]/g, ""));
    });
});
