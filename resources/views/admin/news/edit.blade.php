                                       ...
                                       <form class="forms-sample" id="blog-form"
                                           ...
                                           <div class="form-group">
                                               ...
                                               <input type="text" class="form-control" name="title"
                                                   id="exampleInputName1" placeholder="Title" value="{{ $news->title }}">
                                           </div>
                                           <div class="form-group">
                                               <label for="exampleTextarea1">Sub Title</label>
                                               <textarea class="form-control" name="sub_title" id="exampleTextarea1" rows="4" placeholder="Sub Title">{{ $news->sub_title }}</textarea>
                                           </div>
                                           <div class="form-group">
                                               ...
                                               <div class="form-group">
                                                   ...
                                                   <input type="text" class="form-control" name="meta_tag" id="meta_tag"
                                                       placeholder="Meta Tag" value="{{ $news->meta_tag }}">
                                               </div>
   ...
   @push('js')
       ...
       <script>
           ...
           description.root.innerHTML = "{!! $news->description !!}";
