                           ...
                           <div class="col-12 grid-margin stretch-card">
                               <div class="card">
                                   <div class="card-body">
                                       ...
                                       <form class="forms-sample" id="blog-form" action="{{ route('admin.news.store') }}"
                                           ...
                                           <div class="form-group">
                                               ...
                                               <textarea class="form-control" name="sub_title" id="exampleTextarea1" rows="4" placeholder="Sub Title"></textarea>
                                           </div>
                                           <div class="form-group">
   ...
   @push('js')
       ...
       <script>
           ...
           quill.root.innerHTML = '<p>Initial content goes here...</p>';
