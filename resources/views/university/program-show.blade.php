                ...
                <div class="row rowBox">
                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 columbBox singleProgramsGalleryBigThumnailArea">
                        <div class="singleProgramsGalleryBigThumnail">
                            @foreach ($program->getUniversity[0]->getMedia('university-picture') as $image)
                                @if ($loop->first)
                    ...
                    <div
                        ...
                        <div class="singleProgramsGallerySmallThumnailAreainner">
                            @foreach ($program->getUniversity[0]->getMedia('university-picture') as $key => $image)
                                @if ($key > 0 && $key < 3)
                        ...
                        <div class="singleProgramsDtlsItem">
                            ...
                            <div class="singleProgramsDtlsItem">
                                <h4 class="d-flex align-items-center hdTitle"><span class="icon"><i
                                            class="fa-regular fa-building-columns"></i></span> <span class="txt">Program
                                        Summary</span></h4>
                            ...
                            <div class="applyNowBtnArea text-center mt-4 mb-2">
                                {{-- <a href="apply.html" class="btn btn-primary applyNowBtn"><span class="txt">Apply
                                        Now</span></a> --}}
                            </div>
                            <hr class="borderHr">
                        ...
                        {{-- <div class="sidebarAgentDtlsArea">
                            <div class="sidebarAgentDtlsAreainner">
                                <div class="programsPrice">
                                    <h4 class="mb-0">330,000 AED / yearly</h4>
                                </div>
                                <div class="sidebarAgentSocialBtnArea">
                                    <ul class="sidebarAgentSocialBtnList">
                                        <li><a href="#" class="agentSocialBtn callBtn"><i
                                                    class="fa-regular fa-phone"></i> <span class="txt">Call</span></a>
                                        </li>
                                        <li><a href="#" class="agentSocialBtn emailBtn"><i
                                                    class="fa-regular fa-envelope"></i> <span
                                                    class="txt">Email</span></a></li>
                                        <li><a href="#" class="agentSocialBtn whatsappBtn"><i
                                                    class="fa-brands fa-whatsapp"></i> <span
                                                    class="txt">Whatsapp</span></a></li>
                                    </ul>
                                </div>
                                <div class="sidebarAgentresponse">
                                    <div class="thumnail">
                                        <img src="https://t3.ftcdn.net/jpg/00/64/67/52/360_F_64675209_7ve2XQANuzuHjMZXP3aIYIpsDKEbF5dD.jpg"
                                            class="img-fluid" alt="">
                                    </div>
                                    <div class="content">
                                        <p class="mb-0">Ryan Kenna usually responds within 5 minutes</p>
                                    </div>
                                </div>
                                <div class="sidebarAgentDtlsBottomArea">
                                    <a href="#" class="shortListBtn">Save to shortlist</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="singleProgramsSideBarWidget">
                            ...
                            <div class="singleProgramsSideBarWidgetBody">
                                <ul class="sidebarList">
                                    ...
                                    @endforelse
                                    {{-- <li class="sidebarListItem">
                                        <a href="https://uniwolc.com/programsdetails/2" class="sidebarListLink">
                                            Adipisicing sunt ex
                                        </a>
                                    </li>
                                    <li class="sidebarListItem">
                                        <a href="https://uniwolc.com/programsdetails/4" class="sidebarListLink">
                                            Aut aut reprehenderi
                                        </a>
                                    </li>
                                    <li class="sidebarListItem">
                                        <a href="https://uniwolc.com/programsdetails/5" class="sidebarListLink">
                                            Certification in Master scienece
                                        </a>
                                    </li> --}}
                                    ...
                                    <li class="sidebarListItem">
                                        <div class="sidebarContent">
                                            <div class="sidebarTitle">
                                                £{{ number_format($program->cost_of_living, 2) }}
                                                GBP
                                                / Year</div>
                                            <div class="sidebarText">Cost of Living</div>
                                        </div>
