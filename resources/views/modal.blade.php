    <!-- The Modal -->
    <div class="modal appModal" id="agentStudentEligibilityProgramModal">
        <div class="modal-dialog appModalDiolog">
            <div class="modal-content appModalContent">
                ...
                <form id="agent-student-eligibility-form"
                    action="{{ route('agent.program.apply') }}" method="post">
                    <!-- Modal body -->
                    @csrf
                    ...
                    <div class="modal-body appModalBody">
                        <div class="agent-student-eligibility-programme"
                            ...
                            <div class="form-group" style="font-size: 17px">
                                ...
                                <p>{{ $programDetail->program_title }}</p>
                            </div>
                            <div class="form-group" style="font-size: 17px">
