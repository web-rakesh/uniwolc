                                    ...
                                    <div class="row rowBox2 mt-3">
                                        ...
                                        <div class="col-md-6 mb-3 columnBox2">
                                            ...
                                            <input type="date" class="form-control"
                                                ...
                                                value="{{ $studentDetail->passport_expiry_date ?? old('passport_expiry_date') }}"
                                                required="">
                                        </div>
                                        <div class="col-md-6 mb-3 columnBox2">
                                        ...
                                        <div class="col-md-6 mb-3 columnBox2">
                                            ...
                                            <input type="date" class="form-control"
                                                ...
                                                value="{{ $studentDetail->dob ?? old('dob') }}" required="">
                                        </div>
                                        <div class="col-md-6 mb-3 columnBox2">
                                        ...
                                        <div class="col-md-6 mb-3 columnBox2">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter your facebook"
                                                name="facebook" value="{{ $studentDetail->facebook ?? old('facebook') }}"
                                                required="">
                                        </div>
                                    </div>
