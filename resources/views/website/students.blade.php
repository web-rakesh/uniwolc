...
@section('content')
                ...
                <div class="header-abroad-main">
                    <div class="col-lg-6">
                        <div class="header-abroad-content">
                            <h1>The Easiest Way to Study <span>Abroad</span></h1>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="sub-uniwolc-title sub-choose-tt-pd">
                        <h2>Why Choose <span>UNIWOLC</span>?</h2>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="sub-choose-box">
                        <div class="sub-img-choose">
                            <img src="assets/images/why-choose/01-simple-application.png" alt="" />
                        </div>
                        <h4>Simple Application</h4>
                        <p>Create A Profile In Minutes, Apply To Multiple Schools And Programs In Seconds.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="sub-choose-box">
                        <div class="sub-img-choose">
                            <img src="assets/images/why-choose/02-admission-counselling.png" alt="" />
                        </div>
                        <h4>Admission Counselling</h4>
                        <p>Get expert advice on school and program selection, applications, visa, and travel.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="sub-choose-box">
                        ...
                        <h4>1,600+ Schools</h4>
                        <p>Choose from 125,000+ programs across Canada, the US, the UK, Australia and Ireland.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="sub-choose-box">
                        <div class="sub-img-choose">
                            <img src="assets/images/why-choose/04-financial-guidance.png" alt="" />
                        </div>
                        <h4>Financial Guidance</h4>
                        <p>Get exclusive scholarships and discover financial support options.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="sub-choose-box">
                        <div class="sub-img-choose">
                            <img src="assets/images/why-choose/05-visa-assistance.png" alt="" />
                        </div>
                        <h4>Visa Assistance</h4>
                        <p>Simplify the visa process with advice from certified experts.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="sub-choose-box">
                        <div class="sub-img-choose">
                            <img src="assets/images/why-choose/06-continuous-support.png" alt="" />
                        </div>
                        <h4>Continuous Support</h4>
                        <p>Receive 1-on-1 support from our 10,000+ recruitment partners around the world.</p>
                    </div>
                </div>
    ...
    <!-- HAVE QUESTIONS -->
    <section class="sub-have-quest-pt-pb">
        <div class="container">
            <div class="row">

                <div class="col-lg-12">
                    <div class="sub-count-number-bg sub-have-ques-pt-pb">
    ...
    <section class="sub-how-we-help-bg">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="sub-uniwolc-title sub-choose-tt-pd">
                        <h2>Featured Study Destinations</h2>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="main-universities-blog">
                        ...
                        <div class="sub-content-universities">
                            <h3><a href="javascript:;">Explore Canada</a></h3>
                            <p>Quality education at low cost. Work during study, post-study work permits, and
                                pro-immigration policies. Diverse, safe, and inclusive...</p>
                ...
                <div class="col-lg-4">
                    <div class="main-universities-blog">
                        ...
                        <div class="sub-content-universities">
                            <h3><a href="javascript:;">Explore the United Kingdom</a></h3>
                            <p>World-class universities in the heart of Europe. Shorter study duration to fast-track your
                                career and reduce costs. Options to work...</p>
                            <a href="javascript:;">Learn More</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="main-universities-blog">
                        ...
                        <div class="sub-content-universities">
                            <h3><a href="javascript:;">Explore the United States</a></h3>
                            <p>Globally renowned education from the highest-ranked universities and colleges. Chosen by over
                                a million international students every year...</p>
                            <a href="javascript:;">Learn More</a>
                        </div>
                    </div>
                </div>
    ...
    <!-- Featured Study Destinations End -->

    <!-- Best Programs and Schools -->
                ...
                <div class="sub-best-programs-box">
                    <div class="col-lg-6">
                        <div class="sub-best-programs-content">
                            <h2>Find and Apply to the Best Programs and Schools for You</h2>
                    ...
                    <div class="col-lg-6">
                        <div class="sub-best-img-programs">
                            <img src="assets/images/best-programs-and-schools.png" alt="" />
                        </div>
                    </div>
                </div>
