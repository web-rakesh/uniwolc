            ...
            <div class="singleProgramsGalleryArea">
                <div class="singleProgramsGalleryAreainner">
                    <div class="row rowBox">
                        <div
                            class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 columbBox singleProgramsGalleryBigThumnailArea">
                    ...
                    <div class="col-xl-8 xol-lg-8 col-md-12 col-sm-12 col-12 columBox">
                        <div class="leftSingleProgramsArea">
                            ...
                            <div class="singleProgramsDtlsItem">
                                ...
                                <div class="singleProgramsDtlsItem">
                                    <h4 class="d-flex align-items-center hdTitle"><span class="icon"><i
                                                class="fa-regular fa-book-open-cover"></i></span> <span
                                            class="txt">Similar
                                        ...
                                        @foreach ($intakes as $key => $intake)
                                            <div class="card">
                                                ...
                                                <div id="collapse{{ $key }}"
                                                    ...
                                                    <div class="card-body">
                                                        <b>Open date</b> : {{ $intake->open_date ?? 'No data available' }}
                                                        <br>
                                                        <b>Deadline</b> : {{ $intake->deadline ?? 'No data available' }}
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
...
@push('js')
    <script>
        function replaceWithError(img) {
            img.src = 'https://www.kasandbox.org/programming-images/avatars/leaf-green.png';
        }
    </script>
@endpush
