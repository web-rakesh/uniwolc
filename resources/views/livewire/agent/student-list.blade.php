                            ...
                            <form>
                                <div class="row rowBox">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-6 col-12 columnBox">
                                        <a href="{{ route('agent.student.general.detail') }}"
                ...
                <div class="dashboardTableArea table-responsive">
                    <div id="applicationTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div id="applicationTable_filter" class="dataTables_filter">
                                    <label>Staffs:
                                        <select class="form-control form-control-sm" wire:model="selectedItem">
                                    ...
                                    <tbody>
                                        @forelse ($students ?? [] as $key => $student)
                                            <tr class="tableRowItem odd">
                                                ...
                                                <td>
                                                    <div class="tableContent">{{ $student->userCountry->name }}</div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="tableContent">
                                                        {{ $student->staffDetail ? $student->staffDetail->name : 'N/A' }}
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="tableContent">
                                                ...
                                                <td>
                                                    <div class="tableContent">
                                                        <a href="{{ route('agent.student.general.detail', $student->user_id) }}"
