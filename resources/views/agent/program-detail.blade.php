                ...
                <div class="row rowBox">
                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 columbBox singleProgramsGalleryBigThumnailArea">
                        <div class="singleProgramsGalleryBigThumnail">
                            @foreach ($universityImage as $image)
                                @if ($loop->first)
                    ...
                    <div class="leftSingleProgramsArea">
                        ...
                        <div class="singleProgramsDtlsItem">
                            ...
                            <div class="applyNowBtnArea text-center mt-4 mb-2">
                                <form action="{{ route('agent.program.apply', $program->id) }}" method="post">
                                    <div class="row">
                                        @csrf
                                        <div class="col-6">
                                        ...
                                        <div class="col-6">
                                            <button type="submit" class="btn btn-primary applyNowBtn"><span
                                                    class="txt">Apply
                                                    Now</span></button>
                                            {{--
                                        <a href="{{ route('staff.program.apply', $program->id) }}"
                        ...
                        <div class="singleProgramsSideBarWidget">
                            ...
                            <div class="singleProgramsSideBarWidgetBody">
                                <ul class="sidebarList">
                                    ...
                                    {{-- <li class="sidebarListItem">
                                        <a href="#" class="sidebarListLink">1-Year Post-Secondary
                                            Certificate</a>
                                    </li>
                                    <li class="sidebarListItem">
                                        <a href="#" class="sidebarListLink">1-Year Post-Secondary
                            ...
                            <div class="singleProgramsSideBarWidgetBody">
                                <ul class="sidebarList">
                                    ...
                                    <li class="d-flex justify-content-between sidebarListItem">
                                        ...
                                        <span class="txt">{{ $university->founded }}</span>
                                    </li>
                                    <li class="d-flex justify-content-between sidebarListItem">
                                        <span class="ttl">School ID</span>
                                        <span class="txt">{{ $university->school_id }}</span>
                                    </li>
                                    <li class="d-flex justify-content-between sidebarListItem">
                                        <span class="ttl">DLI number</span>
                                        <span class="txt">{{ $university->provider_id_number }}</span>
                                    </li>
                                    <li class="d-flex justify-content-between sidebarListItem">
                                        <span class="ttl">Institution type</span>
                                        <span class="txt">{{ $university->institution_type }}</span>
                                    </li>
